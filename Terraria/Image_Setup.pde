...
void setupImages() {
  ...
  torsoWalkRight[2] = loadImage("Player/Shirt_16 - Copy.png");
  torsoWalkRight[2].resize(25, 30);
  torsoWalkRight[3] = loadImage("Player/Shirt_20.png");
  torsoWalkRight[3].resize(25, 30);
  torsoWalkRight[4] = loadImage("Player/Shirt_22.png");
  torsoWalkRight[4].resize(25, 30);
  torsoWalkRight[5] = loadImage("Player/Shirt_24.png");
  torsoWalkRight[5].resize(25, 30);
  
  torsoWalkLeft = new PImage[6];
  ...
  dirt = new HashMap<String, PImage>();
  PImage temp = loadImage("Dirt.png");
  temp.resize(tileSize, tileSize);
  dirt.put("1111", temp);
  temp = loadImage("Grass/Grass_0000.png");
  temp.resize(tileSize, tileSize);
  dirt.put("0000", temp);
  ...
  wood = new HashMap<String, PImage>();
  temp = loadImage("Wood/Wood_1111.png");
  temp.resize(tileSize, tileSize);
  wood.put("1111", temp);
  temp = loadImage("Wood/Wood_0000.png");
  temp.resize(tileSize, tileSize);
  wood.put("0000", temp);
  temp = loadImage("Wood/Wood_1000.png");
  temp.resize(tileSize, tileSize);
  wood.put("1000", temp);
  temp = loadImage("Wood/Wood_1100.png");
  temp.resize(tileSize, tileSize);
  wood.put("1100", temp);
  temp = loadImage("Wood/Wood_1110.png");
  temp.resize(tileSize, tileSize);
  wood.put("1110", temp);
  temp = loadImage("Wood/Wood_1101.png");
  temp.resize(tileSize, tileSize);
  wood.put("1101", temp);
  temp = loadImage("Wood/Wood_1011.png");
  temp.resize(tileSize, tileSize);
  wood.put("1011", temp);
  temp = loadImage("Wood/Wood_1010.png");
  temp.resize(tileSize, tileSize);
  wood.put("1010", temp);
  temp = loadImage("Wood/Wood_1001.png");
  temp.resize(tileSize, tileSize);
  wood.put("1001", temp);
  temp = loadImage("Wood/Wood_0111.png");
  temp.resize(tileSize, tileSize);
  wood.put("0111", temp);
  temp = loadImage("Wood/Wood_0011.png");
  temp.resize(tileSize, tileSize);
  wood.put("0011", temp);
  temp = loadImage("Wood/Wood_0001.png");
  temp.resize(tileSize, tileSize);
  wood.put("0001", temp);
  temp = loadImage("Wood/Wood_0100.png");
  temp.resize(tileSize, tileSize);
  wood.put("0100", temp);
  temp = loadImage("Wood/Wood_0101.png");
  temp.resize(tileSize, tileSize);
  wood.put("0101", temp);
  temp = loadImage("Wood/Wood_0010.png");
  temp.resize(tileSize, tileSize);
  wood.put("0010", temp);
  temp = loadImage("Wood/Wood_0110.png");
  temp.resize(tileSize, tileSize);
  wood.put("0110", temp);
